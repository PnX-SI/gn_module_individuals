    ...
    op.execute(
        sa.text(
            ...
            data AS (
                ...
                FROM (
                    VALUES
                    ('Cynthia', 1, '182243', 'CYN-001', '2024-01-01', '2024-06-01', 'Premier équipement', 4),
                    ('Cynthia', 2, '121256-AZ', 'CYN-002', '2024-06-02', NULL, 'Remplacement GPS', 4),
                    ('Claire', 3, '182A256POX', 'CLA-001', '2025-03-15', NULL, 'Pose unique', 6),
                    ('Dominique', 4, '182A25POX5', 'DOM-001', '2025-05-01', '2025-12-01', 'Retrait hivernal', 3),
                    ('Christophe', 5, '210709', 'CHR-001', '2025-02-01', '2026-01-06', 'VHF actif', 4),
                    ('Christophe', 6, '182A256ARG', 'CHR-002', '2026-01-06', NULL, 'Remplacement CHF par GPS', 4),
                    ('Tempête', 7, '18256-9G', 'TMP-001', '2022-01-01', '2023-01-01', 'Ancien dispositif', 6),
                    ('Tempête', 8, '210719', 'TMP-002', '2023-02-01', NULL, 'Dispositif actuel', 6),
                    ('Patastrophe', 9, '121256-AZ', 'PAT-001', '2023-06-01', '2024-01-01', 'Retiré après suivi', 3),
                    ('Obiwan', 10, '182A256ARG', 'OBI-001', '2024-01-10', NULL, 'Suivi GPS', 4),
                    ('Evasion', 11, '18256-9G', 'EVA-001', '2023-03-01', '2023-09-01', 'Premier', 6),
                    ('Evasion', 12, '182A9P6ARP-6', 'EVA-002', '2023-09-02', NULL, 'Remplacement', 6),
                    ('Queen', 13, '1887Y56ZA8', 'QUE-001', '2022-05-01', '2023-05-01', 'Avant désactivation', 3),
                    ('Quechua', 14, '182A256POM', 'QUEC-001', '2024-02-20', NULL, 'Suivi classique', 3),
                    ('Kalinka', 15, '210710', 'KAL-001', '2023-01-01', '2023-07-01', 'Retrait été', 4),
                    ('Pavot', 16, '210721', 'PAV-001', '2024-03-01', NULL, 'Nouveau suivi', 4)
